...
symbols = ['btcusdt', 'ethusdt', 'solusdt', 'bnbusdt', 'dogeusdt', 'wifusdt', 'pnutusdt']
            ...
            try:
                ...
                if usd_size > 500000:
                    ...
                    if usd_size >= 1000000:
                        ...
                        repeat_count = 1
                    if usd_size < 1000000:
                        usd_size = usd_size / 1000
                        usd_symbol = "k"
                    elif usd_size >= 1000000:
                        usd_size = usd_size / 1000000
                        usd_symbol = "m"
                    output = f"{stars} {trade_type} {display_symbol} {readable_trade_time} ${usd_size:.2f}{usd_symbol} "
